...
export const appRoutes: Routes = [
    {
        path: 'user',
        loadChildren: () =>
            import('./user-area/user-area.module').then(m => m.UserAreaModule),
    },
    {
        path: 'moderator',
        loadChildren: () =>
            import('./moderator-area/moderator-area.module').then(m => m.ModeratorAreaModule),
    },
    {
        path: 'administrator',
        loadChildren: () =>
    ...
    { path: 'imprint', pathMatch: 'full', component: ImprintComponent },
    {
        ...
        children: [
            {
                path: ':id',
                canMatch: [canMatchEventId],
                pathMatch: 'full',
                component: NoticesDetailsComponent,
            },
            {
                path: '',
                pathMatch: 'full',
                component: NoticesListComponent,
                data: { reuseRouteKey: 'notices-list' },
            },
        ],
    },
    ...
    },
    {
        ...
        data: { reuseRouteKey: 'events-list' },
    },
